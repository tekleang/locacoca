		...
		<div class="container-fluid sub-banner">
		    <div id="myCarousel" class="carousel slide" data-ride="carousel">	
		    	<div class="item banner-img">
		        	...
		        	<img src="<?php echo $BATH_URL;?>assets/images/Condo-option31-TEAM-banner-01.jpg" alt="Location-banner">
		        	<div class="img">
		         		<a href="<?php echo $BATH_URL;?>"><img src="<?php echo $BATH_URL;?>assets/images/Loca-Resident-logo.svg"></a>
		         	</div>
		         	<div class="text">
		         		<h1>JOIN US TO GROWTH TOGETHER</h1>
		         		<p>OUR TEAM</p>
		         	</div>	        
			    </div>
		    </div>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="items zoom-out">
							<div class="img">
								<img src="<?php echo $BATH_URL;?>assets/images/Condo-option31-team-01.jpg">
							</div>
							<div class="text">
								<h3>MR. SATHYA</h3>
					...
					<div class="col-sm-4">
						<div class="items zoom-out">
							<div class="img">
								<img src="<?php echo $BATH_URL;?>assets/images/Condo-option31-team-02.jpg">
							</div>
							<div class="text">
								<h3>MR. SATHYA</h3>
								<h3>GENERAL MANAGER</h3>
					...
					<div class="col-sm-4">
						<div class="items zoom-out">
							<div class="img">
								<img src="<?php echo $BATH_URL;?>assets/images/Condo-option31-team-03.jpg">
							</div>
							<div class="text">
								<h3>MR. SATHYA</h3>
								<h3>GENERAL MANAGER</h3>
