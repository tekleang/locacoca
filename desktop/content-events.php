		...
		<div class="container-fluid sub-banner">
		    <div id="myCarousel" class="carousel slide" data-ride="carousel">	
		    	<div class="item banner-img">
		        	...
		        	<img src="<?php echo $BATH_URL;?>assets/images/Condo-option31-NEWS-banner-02.jpg" alt="Location-banner">
		        	<div class="img">
		         		<a href="<?php echo $BATH_URL;?>"><img src="<?php echo $BATH_URL;?>assets/images/Loca-Resident-logo.svg"></a>
		         	</div>
		         	<div class="text">
		         		<h1>THE ACTIVITIES WE DID</h1>
		         		<p>NEWS & EVENTS</p>
		         	</div>	        
			    </div>
		    </div>
...
#content .update .zoom-out:hover img{-moz-transform: scale(1);-webkit-transform: scale(1.1);transform: scale(1.1);}
		...
		<div class="container-fluid update">
			<div class="container group-update">
				<h2>WE UPDATE THE LOCA RESIDENT’S ACTIVITY AND EVENTS HAPPENED</h2>
				<div class="row">
					<div class="col-sm-6">
						<div class="items zoom-out">
							<div class="img">
								<img src="<?php echo $BATH_URL;?>assets/images/Condo-option31-NEWS-01.jpg">
							</div>
							<div class="text">
								<h3>WE UPDATE THE LOCA RESIDENT’S ACTIVITY AND EVENTS HAPPENED</h3>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="items zoom-out">
							<div class="img">
								<img src="<?php echo $BATH_URL;?>assets/images/Condo-option31-NEWS-02.jpg">
							</div>
							<div class="text">
								<h3>WE UPDATE THE LOCA RESIDENT’S ACTIVITY AND EVENTS HAPPENED</h3>
							</div>
					...
					<div class="col-sm-6">
						<div class="items zoom-out">
							<div class="img">
								<img src="<?php echo $BATH_URL;?>assets/images/Condo-option31-NEWS-03.jpg">
							</div>
							<div class="text">
								<h3>WE UPDATE THE LOCA RESIDENT’S ACTIVITY AND EVENTS HAPPENED</h3>
							</div>
					...
					<div class="col-sm-6">
						<div class="items zoom-out">
							<div class="img">
								<img src="<?php echo $BATH_URL;?>assets/images/Condo-option31-NEWS-04.jpg">
							</div>
							<div class="text">
								<h3>WE UPDATE THE LOCA RESIDENT’S ACTIVITY AND EVENTS HAPPENED</h3>
							</div>
